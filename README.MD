...
Automation script for connections requests on linkedin

## Use
Open the developper console and past the code.
```javascript
...
main();
```
1. Choose the amout of people you want to invite
2. Choose the amout of time between each request
----
` rmq : in order to avoid being banned the bot can make 500 request per day`.
